...
class ModelMetaClass(type):
	...
	def __new__(cls, name, bases, attrs):
		...
		attrs['__mappings__'] = mappings #save all the attribute and relationship
		attrs['__table__'] = tableName
		attrs['__primary_key__'] = primaryKey
		attrs['__fields__'] = fields #all field except primary key
			
		#build default sql command for selct, insert, update and delete 
